...
import com.example.tabjeel.RendererRecyclerView.widgets.EndlessScrollListener;
import com.example.tabjeel.RendererRecyclerView.widgets.ItemOffsetDecoration;
...
//		mAdapter.setLoadMoreModel(new YourLoadMoreModel()); /* you can change the LoadMoreModel if needed */
		...
		mAdapter.registerRenderer(new ViewBinder<>(R.layout.item_simple_2, SimpleViewModel.class,
